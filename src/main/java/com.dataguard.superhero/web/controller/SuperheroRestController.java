...
@RestController
@Validated
@RequestMapping(value = "/api/v1", produces = "application/vnd.api.v1+json")
...
public class SuperheroRestController {
    ...
    @PostMapping(value = SUPERHEROS_PATH)
    ...
    @GetMapping(value = SUPERHEROS_ID_PATH)
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "OK", content = {
            @Content(mediaType = "application/json", schema = @Schema(implementation = Superhero.class))})})
    @Operation(summary = "get Superhero Object with id")
    public ResponseEntity<Superhero> getSuperHeroById(@PathVariable @NotNull Long id) {
    ...
    @GetMapping(value = SUPERHEROS_PATH)
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "OK", content = {
            @Content(mediaType = "application/json", schema = @Schema(implementation = Superhero.class))})})
    ...
    @DeleteMapping(value = SUPERHEROS_ID_PATH)
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "OK", content = {
            @Content(mediaType = "application/json", schema = @Schema(implementation = Superhero.class))})})
    @Operation(summary = "Delete superhero with given ID")
    public ResponseEntity<?> deleteSuperhero(@PathVariable @NotNull Long id) {
        log.info ( " Delete superhero with id: {}  is requested ", id );
        superheroService.deleteSuperhero ( id );
        return ResponseEntity.ok ( "Superhero deleted" );
    }

    @PatchMapping(value = SUPERHEROS_ID_PATH)
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "OK", content = {
            @Content(mediaType = "application/json", schema = @Schema(implementation = Superhero.class))})})

    @Operation(summary = "Changes superhero's some attributes limited with (name,alias or origin attributes)")
    public ResponseEntity<SuperheroDTO> updateSuperHero(@PathVariable @NotNull Long id, @RequestBody @NotNull SuperheroBaseDTO superheroBaseDTO) {
    ...
    @PutMapping(value = SUPERHEROS_ID_PUT_ATTRIBUTE_PATH)
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "OK", content = {
            @Content(mediaType = "application/json", schema = @Schema(implementation = Superhero.class))})})
    ...
    public ResponseEntity<SuperheroDTO> addAttribute(@PathVariable @NotNull Long id,
                                                     @PathVariable @Valid @Type String type,
    ...
    public ResponseEntity<SuperheroDTO> removeAttribute(@PathVariable @NotNull Long id,
                                                        @PathVariable @Valid @Type String type,
                                                        @PathVariable @NotNull String name) {
